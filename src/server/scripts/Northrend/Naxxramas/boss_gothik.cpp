...
struct NotOnSameSide : public Trinity::unary_function<Unit *, bool> {
    bool m_inLiveSide;
...
public:
    ...
    struct boss_gothikAI : public BossAI
    {
        ...
        void EnterCombat(Unit * /*who*/)
        {
            ...
            {
                TC_LOG_ERROR("server", "Script Gothik: cannot summon triggers!");
                EnterEvadeMode();
                return;
            }
        ...
        void JustSummoned(Creature *summon)
        {
            ...
            {
                summon->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_DISABLE_MOVE|UNIT_FLAG_NOT_SELECTABLE);
